...
function buildInsightItems(data: InsightsData): Item[] {
  ...
  const sunsetLabel =
    sunsetIn > 0 ? `In ${sunsetIn}h ${setMin}m` : sunsetIn === 0 ? "Within the hour" : "Passed";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          className="flex items-center gap-1 rounded border border-white/[0.04] bg-white/[0.02] px-1.5 py-0.5 text-[8px] font-semibold uppercase tracking-wider"
          style={{ color: "#6b6b7b", fontFamily: "JetBrains Mono" }}
        >
      ...
      <div className="mt-2 flex items-baseline gap-1.5">
        <span
          className="text-[1.75rem] font-bold tabular-nums leading-none"
